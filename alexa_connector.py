    ...
    def blueprint(self, on_new_message):
        ...
        async def receive(request):
            ...
            if intenttype == "LaunchRequest":
                message = "Bonjour! Bienvenue dans la version Alexa de l'assistant conversationnel Legilux. Quelle est votre question?"
                session = "false"
            else:
                ...
                if intent == "AMAZON.StopIntent":
                    ...
                    await on_new_message(UserMessage(text, out, input_channel="alexa"))
                    # extract the text from Rasa's response
                    logger.info(f'------------RAW OUT: {out}')

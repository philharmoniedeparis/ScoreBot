...
raw_sentences = {
    "get_sheet_music_by_casting": {
        "sentences": [
            ...
            "Une transcription _WORK_NAME pour _MEDIUM",
            ...
            "Une partition de _WORK_NAME de _AGENT",
            "Une partition du _WORK_NAME d'_AGENT",
            "Partition _WORK_NAME _AGENT",
            "_WORK_NAME de _AGENT",
            "_WORK_NAME d'_AGENT",
            "_WORK_NAME du _AGENT",
            "Une partition d'_MEDIUM de _WORK_NAME de _AGENT",
            "Une partition d'_MEDIUM de _WORK_NAME d'_AGENT",
            "Je veux une partition d'_MEDIUM, de _WORK_NAME, d'_AGENT",
            "Donne-moi une partition d'_MEDIUM de _WORK_NAME d'_AGENT",
            "Une partition pour _MEDIUM de _WORK_NAME d'_AGENT",
            "Une partition de _WORK_NAME d'_AGENT pour _MEDIUM",
            "Une partition de _WORK_NAME d'_AGENT de _MEDIUM",
            "Je veux une partition de _WORK_NAME d'_AGENT de _MEDIUM",
            "Donne-moi une partition de _WORK_NAME d'_AGENT de _MEDIUM",
            "Partition d'_MEDIUM de _WORK_NAME d'_AGENT",
            "Partition d'_MEDIUM de _WORK_NAME de _AGENT",
            "Une partition de _MEDIUM de _WORK_NAME de _AGENT",
            ...
            "partition de réduction pour _MEDIUM de l'ouverture du _WORK_NAME.",
            "Je veux la partition de la réduction pour _MEDIUM de l'ouverture de _WORK_NAME.",
            "Je veux la partition pour _MEDIUM de l'ouverture de _WORK_NAME.",
            "Partition pour _MEDIUM de l'ouverture de _WORK_NAME.",

...
raw_sentences = {
    "get_sheet_music_by_casting": {
        "sentences": [
            ...
            "Avez-vous des partitions d'_AGENT pour _MEDIUM et _MEDIUM ? ",
            "Avez-vous des partitions _MEDIUM écrites par _AGENT ?",
            "Avez-vous des partitions _MEDIUM écrites par _AGENT ?",
            "Je cherche les parties de _MEDIUM de _AGENT",
            "Où sont rangées les partitions pour _MEDIUM de _AGENT ?",
            ...
            "Je cherche une sonate pour _MEDIUM et _MEDIUM de _AGENT.",
            "Je cherche une pièce de _AGENT pour _MEDIUM et _MEDIUM",
            "Je cherche une pièce de _AGENT pour _MEDIUM et _MEDIUM",
            "Un songbook des _AGENT pour _MEDIUM et _MEDIUM",
            "Les partitions pour _MEDIUM sur des poèmes de _AGENT",
            "Vous avez des partitions du _AGENT ?",
            "Vous avez des partitions de l'_AGENT ?",
            "Vous avez des partitions d'_AGENT ?",
            ...
            "Je recherche une partition d'_AGENT pour _MEDIUM et _MEDIUM ",
